...
class Test_radio24G_Edit():
    ...
    def test_RADIO24G_EDIT_RES_6(self):
        ...
        self.radio2GViewClt.assert_val_lst(self.bandwithGUI_exp_lst, bandwithGUI_actual_lst)
        self.radio2GViewClt.assert_val_lst(self.channelGUI_exp_lst, channelGUI_actula_lst)
