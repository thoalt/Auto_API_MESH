...
class Test_radio24G_Edit():
    ...
    def set_up(self):
        ...
        self.data = ['radio2.4GEdit1', 'radio2.4GEdi', 'Radio2.4GEdit', 'radio24GEdit',
                     'radio2.4gedit', 'RADIO2.4GEIT',
                     '', 'radio2.4GEdit112214412414124124124175757',
                     'radio2.4GEdit ', ' radio2.4GEdit', 'radio2.4G Edit']
