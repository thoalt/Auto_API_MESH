...
class Test_ssid24GView():
    ...
    def set_up(self):
        ...
        self.data = self.ssid24GViewClt.Remove_Request_ID_In_Pload(pload)


    def test_ssid24GView_miss_REQID(self):
        time.sleep(self.timeOut)
        resBody_lst = []
        for item in self.data:
            resBody = self.ssid24GViewClt.ssid24GView(self.cookie, pload=item).body
