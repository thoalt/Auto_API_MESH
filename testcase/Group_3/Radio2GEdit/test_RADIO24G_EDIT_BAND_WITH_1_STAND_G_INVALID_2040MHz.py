...
class Test_radio24G_Edit():
    ...
    def set_up(self):
        ...
        self.bandwith_API_lst = [BAND_WITH_API.B_20_40]

        self.bandwith_GUI_exp = [BAND_WITH_GUI.B_20_40]
    ...
    def test_RADIO24G_EDIT_RES_6(self):
        ...
        for item in self.bandwith_API_lst:
            ...
            # Standard auto change from 11g to 11ng
            standard = self.wrp.get_Standard2G_sp()
            self.radio2GViewClt.assert_val(STANDARD_2G.MOD_NG, standard)
