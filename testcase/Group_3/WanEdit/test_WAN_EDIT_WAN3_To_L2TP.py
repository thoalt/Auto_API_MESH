...
class Test_Wan_Create():
    ...
    def set_up(self):
        ...
        self.idx = 1
        self.vlanID = 10
        self.wanTypeAfter = WAN_TYPE().L2TP
    ...
    def test_WAN_EDIT_RES_1(self):
        ...
        pload = self.wanEditClt.Create_WanCreate_Edit_WAN_L2TP(
            pload=ploadCom,
            server=self.serverL2TP,
            userName=self.userName_L2TP,
            pword=self.passW_L2TP)
        ...
        self.wanViewClt.assert_val(self.serverL2TP, self.wp.get_Input_Server())
        self.wanViewClt.assert_val(self.userName_L2TP, self.wp.get_Input_User())
        self.wanViewClt.assert_val(self.passW_L2TP, self.wp.get_Input_Password())