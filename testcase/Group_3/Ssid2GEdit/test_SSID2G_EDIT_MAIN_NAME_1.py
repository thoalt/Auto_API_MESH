...
class Test_ssid2GEdit():
    ...
    def set_up(self):
        ...
        self.data = ["e", "5", "%", "`", "t!", "gh", "3#",
                    "test@hec", " wireless@hec", "wireless@hec ", "wireless@ hec", "wireless@  hec", "wireless@ test hec",
                    "uidwvgNleD1234567890`~!@#$%^*()_",
                    "uidwvgNleD1234567890-=+{[]}|;:<",
                    "uidwvgNleD1234567890.>?/txblaudp"]

        # self.data = ["uidwvgNleD1234567890`~!@#$%^*()_",
        #             "uidwvgNleD1234567890-=+{[]}|;:<",
        #             "uidwvgNleD1234567890.>?/txblaudp"]
    def test_ssid2GEdit_RES_1(self):
        for idx, item in enumerate(self.data):
            ...
            with soft_assertions():
                ...
                self.ssid2GEditClt.assert_val(item, driver_SSID_2G)

                if self.enable:
                    self.ssid2GEditClt.assert_val(item, gui_SSID.ssidName)
                    if self.authenmode != "open":
                        self.ssid2GEditClt.assert_val(self.password + ranIdx, gui_SSID.password)
