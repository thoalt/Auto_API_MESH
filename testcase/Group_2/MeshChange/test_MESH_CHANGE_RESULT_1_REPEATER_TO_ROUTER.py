...
class Test_Mesh_Create():
    ...
    def set_up(self):
        ...
        pload = self.meshCreateClt.Create_meshCreate_Pload(meshMode=MESH_MODE.REPEATER,
                                                           ssidName="ThoaTest_repeater",
                                                           passW="1234567890")

        pload = self.meshCreateClt.Create_meshCreate_Mode_Repeater_Pload(payload=pload,
                                                                         ReSsidName="1111_AP_Wireless_Test_2GHz",
                                                                         ReAutheMode=AUTHEN_MODE.OPEN)
