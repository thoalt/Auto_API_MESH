...
class Test_TraceRoute():
    ...
    def set_up(self):
        ...
        self.data = [self.traceClt.Remove_Key_In_Pload(pload, 'action'),
                     self.traceClt.Remove_Key_In_Pload(pload, 'tracerouteCode'),
                     self.traceClt.Remove_Key_In_Pload(pload, 'host')]
